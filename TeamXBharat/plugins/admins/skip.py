...
from TeamXBharat.utils.database import get_loop
from TeamXBharat.utils.decorators import AdminRightsCheck
from TeamXBharat.utils.inline import close_markup, stream_markup
...
@app.on_message(
    filters.command(["skip", "cskip", "next", "cnext"], prefixes=["/", "!", "%", ",", ".", "@", "#", "champu", "Champu"]) & filters.group & ~BANNED_USERS
)
@AdminRightsCheck
